...
let of_jsonrpc (request: Jsonrpc.Request.t) =
  ...
  | "textDocument/didOpen" ->
    request
    |> Jsonrpc.Request.params (fun json -> TextDocumentDidOpen (DidOpenParams.t_of_yojson json))
  | "textDocument/didChange" ->
    request
    |> Jsonrpc.Request.params (fun json -> TextDocumentDidChange (DidChangeParams.t_of_yojson json))
  | "textDocument/didClose" ->
    request
    |> Jsonrpc.Request.params (fun json -> TextDocumentDidClose (DidCloseParams.t_of_yojson json))
